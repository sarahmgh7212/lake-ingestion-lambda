<template>
<div id="register" class="bg-white font-family-karla h-screen">
            ...
            <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                ...
                <form class="flex flex-col pt-3 md:pt-8" onsubmit="event.preventDefault();">
                    ...
                    <!-- <input type="submit" value="Register" class="bg-black text-white font-bold text-lg hover:bg-gray-700 p-2 mt-8"> -->
                             <button class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transition mt-8 duration-200" type="submit">Register</button>
                </form>
                <div class="text-center pt-12 pb-12">
                    <p>Already have an account? <span class="underline font-semibold"><router-link :to="{name:'auth.login'}">Log in here</router-link></span> </p>
